...
def main():
    # cuda = "cuda:1"
    layer = "relu2_all_white_64/"
    flag = "relu2"
    mode = "train"
    step = 0.7
    end_epoch = 14
    # device = torch.device(cuda)ç
    ...
    train_kwargs = {'batch_size': 64} # TODO check this
    test_kwargs = {'batch_size': 1000} # TODO check this
    ...
    for epoch in range(begin_epoch, end_epoch):
        ...
        if mse_loss < target_mse_loss:
            ...
            record(classifier, inversion, device, test_loader, epoch, flag+"_same", 32, mse_loss)
